...
var zdruzeno = uglifyJs.minify({
  ...
  'navigacijaProfesor.directive.js': fs.readFileSync('app_client/total/directives/navigacijaProfesor/navigacijaProfesor.directive.js', 'utf8'),
  'navigacijaStudent.directive.js': fs.readFileSync('app_client/total/directives/navigacijaStudent/navigacijaStudent.directive.js', 'utf8'),
  'navigacijaPodatkiStudenta.directive.js': fs.readFileSync('app_client/total/directives/navigacijaPodatkiStudenta/navigacijaPodatkiStudenta.directive.js', 'utf8'),
  ...
  'dodajIzvajalcaIzpitProfesorCtrl.js': fs.readFileSync('app_client/controllers/dodajIzvajalcaIzpitProfesor.controller.js', 'utf8'),
  ...
  'urejanjeIzpitniRokProfesorCtrl.js': fs.readFileSync('app_client/controllers/urediIzpitniRokProfesor.controller.js', 'utf8'),
  'urejanjeIzpitniRokReferentkaCtrl.js': fs.readFileSync('app_client/controllers/urediIzpitniRokReferentka.controller.js', 'utf8'),
  'izberiZetonCtrl.js': fs.readFileSync('app_client/controllers/izberiZeton.controller.js', 'utf8'),
  'elektronskiIndeksCtrl.js': fs.readFileSync('app_client/controllers/elektronskiIndeks.controller.js', 'utf8'),
  'seznamVpisanihVLetnikCtrl.js': fs.readFileSync('app_client/controllers/seznamVLetniku.controller.js', 'utf8')
