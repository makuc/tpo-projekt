(function() {
    ...
    urediVrsteStudijaCtrl.$inject = ['ostaloPodatki', '$scope', '$location', 'authentication'];
    
    
    function urediVrsteStudijaCtrl(ostaloPodatki, $scope, $location, authentication){
        var vm = this;
        ...
        vm.exportDataPDF= function(){
            ...
            var docDefinition = {
               	content: [
                    { text: '', style: 'header' },
                    table($scope.query,
                       [ 'sifra', 'opis', 'klasiusSRV', 'predpona'],
                        ['#','Šifra', 'Opis', 'KlasiusSRV','Predpona'])
                ]
