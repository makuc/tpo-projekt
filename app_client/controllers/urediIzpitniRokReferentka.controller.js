(function(){
    ...
    urejanjeIzpitniRokReferentkaCtrl.$inject = ['$routeParams', '$location', 'izpitniRokPodatki', 'authentication', 'ostaloPodatki'];
    
    function urejanjeIzpitniRokReferentkaCtrl($routeParams, $location, izpitniRokPodatki, authentication, ostaloPodatki) {
        var vm = this;
    ...
    angular
        .module('tpo')
        .controller("urejanjeIzpitniRokReferentkaCtrl", urejanjeIzpitniRokReferentkaCtrl);
