(function() {
    ...
    urediStudijskeProgrameCtrl.$inject = ['ostaloPodatki', '$scope', '$location', 'authentication'];
    
    
    function urediStudijskeProgrameCtrl(ostaloPodatki, $scope, $location, authentication){
        var vm = this;
        ...
        vm.exportDataPDF= function(){
            ...
            var docDefinition = {
               	content: [
                    { text: '', style: 'header' },
                    table($scope.query,
                        ['sifraEVS', 'sifra', 'naziv', 'vrstaStudija.opis' , 'semestri'],
                        ['#','Šifra EVS','Šifra', 'Naziv','Vrsta študija', 'Semestri'])
                ]
