        ...
        vm.exportDataPDF= function(){
            ...
            var docDefinition = {
               	content: [
                    { text: '', style: 'header' },
                    table($scope.query,
                        ['studijski_program.naziv', 'studijski_program.vrstaStudija.opis', 'studijsko_leto.studijsko_leto', 'letnik.naziv', 'del_predmetnika.naziv', 'ime'],
                        ['#','Naziv','Vrsta študija', 'Študijsko leto','Letnik','Del predmetnika', 'Ime modula'])
                ]
